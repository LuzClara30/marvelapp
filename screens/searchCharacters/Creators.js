...
const Creators = ({route}) => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://gateway.marvel.com:443/v1/public/creator/${searchTerm}?&ts=1&apikey=60aaa1ccf66c273c5d5983f388993fd1&hash=914796b1123c53d97218163f05ce53c5`
      )
      .then((res) => {
